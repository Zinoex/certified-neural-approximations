...
├── certified_neural_approximations             # The main python package for the project
...
e.g: `cat certified_neural_approximations/VERSION` will get the project version without harming
