...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "grid_neural_abstractions = 'grid_neural_abstractions.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run grid_neural_abstractions'"
