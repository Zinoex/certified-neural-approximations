...
from ..translators.taylor_translator import TaylorTranslator
...
class TaylorLinearization:
    ...
    def linearize_sample(self, sample):
        ...
        taylor_expansion = first_order_certified_taylor_expansion(
    ...
    def get_taylor_expansion(self, expansion_point, delta):
        ...
        """
        return first_order_certified_taylor_expansion(
    ...
    def evaluate_at_point(self, point):
        ...
        expansion = first_order_certified_taylor_expansion(
