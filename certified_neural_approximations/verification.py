...
from certified_neural_approximations.certification_results import AugmentedSample, CertificationRegion, \
...
class VerificationStrategy(ABC):
    @abstractmethod
    def verify(self, data: CertificationRegion, epsilon, precision=1e-6):
        """
